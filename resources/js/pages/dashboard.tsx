...
import { absensi, dashboard, logBook, sertifikat } from '@/routes';
...
function BarChart({
    ...
    const maxValue = Math.max(
        ...data.map(
            (item) => item.hadir + item.izin + item.sakit + item.terlambat,
        ),
        60,
    );
    const colors = {
...
export default function Dashboard() {
    ...
    const [absensiPeriod, setAbsensiPeriod] = useState<
    ...
    if (mode === 'peserta') {
        const unreadBadge =
            props.notifikasi?.unread ?? props.notifikasiUser?.unread ?? 0;
        return (
                ...
                <div className="space-y-6 px-6 py-6">
                    <div className="flex items-start justify-between">
                        ...
                        <div className="relative">
                            ...
                            {unreadBadge > 0 && (
                                <span className="ml-2 inline-flex items-center rounded-full bg-red-600 px-2 py-0.5 text-xs font-semibold text-white">
                                    {unreadBadge}
                                </span>
                            )}
                        </div>
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        <Card className="border-0 p-6 shadow-sm">
                            ...
                            <div className="grid gap-3">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium">
                                        {props.schedule
                                            ? `${props.schedule.jam_buka}–${props.schedule.jam_tutup}`
                                            : '-'}
                                    </span>
                                </div>
                            </div>
                        ...
                        <Card className="border-0 p-6 shadow-sm">
                            ...
                            <div className="space-y-3">
                                {(
                                    props.notifikasi?.list ??
                                    props.notifikasiUser?.list ??
                                    []
                                ).map((n, idx) => (
                                    <div
                                        key={idx}
                                    ...
                                    >
                                        <div className="flex items-start justify-between">
                                            <div>
                                                ...
                                                <p className="text-black-700 mt-1 text-sm">
                                                    {n.pesan}
                                                </p>
                                            </div>
                    ...
                    <Card className="border-0 p-6 shadow-sm">
                        ...
                        <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                            <div className="rounded-lg bg-green-300 p-4 text-center">
                                <p className="text-2xl font-bold text-white">
                                    {props.absensiStats?.hadir ?? 0}
                                </p>
                                <p className="mt-1 text-sm font-bold text-gray-900">
                                    Hadir
                                </p>
                            </div>
                            <div className="rounded-lg bg-blue-300 p-4 text-center">
                                <p className="text-2xl font-bold text-white">
                                    {props.absensiStats?.izin ?? 0}
                                </p>
                                <p className="mt-1 text-sm font-bold text-gray-900">
                                    Izin
                                </p>
                            </div>
                            <div className="rounded-lg bg-yellow-300 p-4 text-center">
                                <p className="text-2xl font-bold text-white">
                                    {props.absensiStats?.sakit ?? 0}
                                </p>
                                <p className="mt-1 text-sm font-bold text-gray-900">
                                    Sakit
                                </p>
                            </div>
                            <div className="rounded-lg bg-red-300 p-4 text-center">
                                <p className="text-2xl font-bold text-white">
                                    {props.absensiStats?.terlambat ?? 0}
                                </p>
                                <p className="mt-1 text-sm font-bold text-gray-900">
                                    Terlambat
                                </p>
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 px-6 py-6">
                ...
                <Card className="border-0 p-6 shadow-sm">
                    <h2 className="mb-4 text-lg font-semibold text-gray-900">
                        Penyelesaian Logbook Bulan Ini
                    </h2>
                    <div className="flex items-center gap-4">
                        <Progress value={props.logbookCompletionPercent ?? 0} />
                        <span className="text-sm font-medium text-gray-700">
                            {props.logbookCompletionPercent ?? 0}%
                        </span>
                    </div>
                </Card>
                    ...
                    <div className="grid grid-cols-2 gap-4 md:grid-cols-5">
                        ...
                        <div className="rounded-lg bg-gray-50 p-4 text-center">
                            <p className="text-2xl font-bold text-gray-600">
                                {props.absensiHariIni?.belumAbsen ?? 0}
                            </p>
                            <p className="mt-1 text-sm text-gray-600">
                                Belum Absen
                            </p>
